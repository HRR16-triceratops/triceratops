...
export const CANCELPOPUP_OPEN = 'CANCELPOPUP_OPEN';
export const CANCELPOPUP_CLOSE = 'CANCELPOPUP_CLOSE';
export const REMOVEPOPUP_OPEN = 'REMOVEPOPUP_OPEN';
export const REMOVEPOPUP_CLOSE = 'REMOVEPOPUP_CLOSE';
export const GENERALPOPUP_CLOSE = 'GENERALPOPUP_CLOSE';
export const GENERALPOPUP_OPEN = 'GENERALPOPUP_OPEN';
